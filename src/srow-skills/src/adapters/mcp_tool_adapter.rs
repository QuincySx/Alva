...
use srow_engine::domain::tool::ToolDefinition;
use srow_engine::ports::tool::{Tool, ToolContext};

use crate::application::mcp_manager::McpManager;
use crate::domain::mcp::McpToolInfo;

/// Wraps a single MCP Tool as a srow_engine Tool trait implementation
///
