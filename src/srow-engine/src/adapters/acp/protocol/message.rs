...
mod tests {
    use super::*;
    use crate::adapters::acp::protocol::lifecycle::TaskFinishReason;
    use crate::adapters::acp::protocol::permission::PermissionOption;
    ...
    fn test_outbound_permission_response_serde() {
        let msg = AcpOutboundMessage::PermissionResponse {
            ...
            data: crate::adapters::acp::protocol::permission::PermissionData {
