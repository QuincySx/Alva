                ...
                div()
                    ...
                    .child(
                        Button::new("proxy-toggle")
                            ...
                            .small()
                            .on_click(cx.listener(alva_app_debug::traced_listener!("settings:proxy_toggle", |this, _, _, cx| {
                ...
                div()
                    ...
                    .child(
                        Button::new("save-btn")
                            ...
                            .primary()
                            .disabled(!dirty)
                            .on_click(cx.listener(alva_app_debug::traced_listener!("settings:save", |this, _, _, cx| {
                                if this.dirty {
                                    this.save(cx);
                                }
                            })))
...
impl SettingsPanel {
    ...
    fn render_theme_button(
        ...
        div()
            ...
            .child(label_str)
            .on_click(cx.listener(alva_app_debug::traced_listener!("settings:theme_mode", move |this, _, _, cx| {
