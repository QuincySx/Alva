...
pub enum ContentBlock {
    ...
    ToolResult {
        ...
        id: String,
        content: Vec<crate::tool_payload::ToolContent>,
        is_error: bool,
    },
}
...
impl ContentBlock {
    ...
    pub fn as_tool_result(&self) -> Option<(&str, &[crate::tool_payload::ToolContent], bool)> {
        match self {
...
mod tests {
    ...
    fn tool_result_block() -> ContentBlock {
        ContentBlock::ToolResult {
            id: "tu_1".into(),
            content: vec![crate::tool_payload::ToolContent::text("found foo")],
            is_error: false,
        }
    }
