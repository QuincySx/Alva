// INPUT:  regex, std::path, dirs
// OUTPUT: SensitivePathFilter
// POS:    Filters access to sensitive paths (secrets, certificates, private config) using dirs, extensions, filenames, and regex patterns.
use regex::Regex;
