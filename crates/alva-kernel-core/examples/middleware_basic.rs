// INPUT:  alva_kernel_core, alva_kernel_abi, async_trait
...
#[async_trait]
impl alva_kernel_abi::LanguageModel for StubModel {
    async fn complete(
        &self,
        _: &[Message],
        _: &[&dyn alva_kernel_abi::Tool],
        _: &alva_kernel_abi::ModelConfig,
    ) -> Result<alva_kernel_abi::CompletionResponse, alva_kernel_abi::AgentError> {
        Ok(alva_kernel_abi::CompletionResponse::from_message(Message {
            id: "stub".to_string(),
    ...
    fn stream(
        ...
        Box::pin(tokio_stream::iter(vec![
            ...
            alva_kernel_abi::StreamEvent::Done,
        ]))
    }
