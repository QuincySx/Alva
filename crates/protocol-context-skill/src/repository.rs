// INPUT:  crate::types, crate::error, async_trait
// OUTPUT: SkillRepository (trait), SkillInstallSource
// POS:    Abstract Skill repository interface for list/find/load/install/remove operations.
use crate::error::SkillError;
use crate::types::{Skill, SkillBody, SkillMeta, SkillResource};
