...
| AgentRuntimeBuilder | src/builder.rs | Builder pattern for constructing a fully-configured AgentRuntime with tools, middleware, model, and a default or injected BusHandle |
