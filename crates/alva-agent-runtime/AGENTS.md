...
> Batteries-included agent runtime composing alva-agent-core + alva-agent-tools + alva-agent-security + alva-agent-memory with a builder API.
...
| AgentRuntimeBuilder | src/builder.rs | Builder pattern for constructing a fully-configured AgentRuntime with tools, middleware, model, bus, and an optional standard agent stack |
