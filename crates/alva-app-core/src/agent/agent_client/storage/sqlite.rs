// INPUT:  crate::agent::agent_client::AcpError, tokio::sync, uuid, chrono, serde_json
// OUTPUT: AcpMessageStorage
// POS:    In-memory ACP message persistence (placeholder for future SQLite migration).
