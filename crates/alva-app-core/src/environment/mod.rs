// INPUT:  std::collections, std::path, tracing, config, installer, manifest, resolver, versions
// OUTPUT: EnvironmentManager, EnvironmentError
// POS:    Central manager for embedded runtime environments — coordinates manifest loading, version checking, installation, and path resolution.
