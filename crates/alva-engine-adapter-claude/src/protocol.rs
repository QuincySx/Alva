...
mod tests {
    ...
    fn test_real_sdk_system_init() {
        ...
        match msg {
            BridgeMessage::SdkMessage {
                ...
                assert_eq!(
                    session_id.as_deref(),
                    Some("fcbc2425-ffaa-4c32-a9b4-38cd5800bb02")
                );
    ...
    fn test_real_sdk_stream_event_text_delta() {
        ...
        match msg {
            BridgeMessage::SdkMessage {
                message: SdkMessage::StreamEvent { uuid, event },
            } => {
                assert_eq!(
                    uuid.as_deref(),
                    Some("b4919f8d-2934-4098-8479-0202b32e4035")
                );
    ...
    fn test_real_sdk_assistant_message() {
        ...
        match msg {
            BridgeMessage::SdkMessage {
                message: SdkMessage::Assistant { uuid, message, .. },
            } => {
                assert_eq!(
                    uuid.as_deref(),
                    Some("e6944592-7141-4f55-b996-686576cdb540")
                );
