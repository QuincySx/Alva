// INPUT:  srow_core::{FsSkillRepository, SkillInjector, SkillLoader, SkillStore, Skill, SkillKind, SkillMeta, InjectionPolicy, SkillRef, SkillRepository}, std::path, tempfile
