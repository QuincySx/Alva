// INPUT:  serde, crate::domain::agent
// OUTPUT: OrchestratorAgentTemplate, predefined_templates
// POS:    Defines Agent template blueprints and provides four predefined templates (browser/coding/system/research).
