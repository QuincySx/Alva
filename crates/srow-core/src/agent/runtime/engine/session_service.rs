// INPUT:  crate::domain::agent, crate::domain::session, crate::error, crate::ports::storage, std::sync, uuid
// OUTPUT: SessionService
// POS:    Service layer for session CRUD operations (create from config, resume with validation, list by workspace).
