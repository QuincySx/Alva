// INPUT:  browser_manager, browser_start, browser_stop, browser_navigate, browser_action, browser_snapshot, browser_screenshot, browser_status
// OUTPUT: BrowserManager, BrowserStartTool, BrowserStopTool, BrowserNavigateTool, BrowserActionTool, BrowserSnapshotTool, BrowserScreenshotTool, BrowserStatusTool
// POS:    Module declaration and re-exports for the 7 browser automation tools and their shared manager.
