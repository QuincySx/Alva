// INPUT:  std::collections, tokio::sync, crate::agent::agent_client::protocol::permission
// OUTPUT: PermissionManager
// POS:    ACP-level permission cache storing AllowAlways/RejectAlways decisions across prompts.
use std::collections::HashMap;
use tokio::sync::RwLock;

use crate::agent::agent_client::protocol::permission::{PermissionData, PermissionOption};
