// INPUT:  serde
// OUTPUT: PermissionRequest, RiskLevel, PermissionData, PermissionOption
// POS:    ACP permission request/response types with four-option HITL model (allow/reject once/always).
