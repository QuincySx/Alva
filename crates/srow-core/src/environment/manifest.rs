...
// OUTPUT: ResourceManifest, ComponentVersion, ArtifactConfig, ArchiveFormat, ManifestError
// POS:    Parses resource_manifest.json defining expected runtime component versions and artifact packaging.
