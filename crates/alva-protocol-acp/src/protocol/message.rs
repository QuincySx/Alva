...
/// ACP protocol: External Agent -> Host (read from stdout)
...
/// ACP protocol: Host -> External Agent (written to stdin)
#[derive(Debug, Clone, Serialize, Deserialize)]
...
mod tests {
    use super::*;
    use crate::protocol::lifecycle::TaskFinishReason;
    use crate::protocol::permission::PermissionOption;
