// INPUT:  tokio, crate::error, crate::protocol::{bootstrap, message}, super::discovery, super::orphan
// OUTPUT: AcpProcessHandle, ProcessState
// POS:    ACP child process handle — spawning, stdio communication, and lifecycle state
