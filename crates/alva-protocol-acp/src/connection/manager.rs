// INPUT:  tokio, crate::error, crate::protocol::message, super::discovery, super::process, super::orphan
// OUTPUT: AcpProcessManager, ProcessManagerConfig
// POS:    Global ACP process manager — spawning, routing, and lifecycle management of external agent processes
...
use super::discovery::{AgentDiscovery, ExternalAgentKind};
use super::orphan::cleanup_orphan_processes;
use super::process::{AcpProcessHandle, ProcessState};
