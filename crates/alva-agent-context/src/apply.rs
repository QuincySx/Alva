// INPUT:  alva_types (AgentMessage, ContentBlock, Message, MessageRole), crate::types, crate::sdk::ContextHandle, tracing, uuid, chrono
// OUTPUT: pub async fn apply_injections, pub async fn apply_compressions
// POS:    Execution helpers that apply Injection and CompressAction results to mutable state, decoupling agent_loop from context internals.
//! Helpers for applying context hook results to agent state.
//!
//! These functions encapsulate the logic of "what does this Injection/CompressAction
//! mean for system_prompt and messages", keeping the agent_loop clean.
