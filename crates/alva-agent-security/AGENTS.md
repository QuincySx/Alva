...
| SecurityGuard | src/guard.rs | Unified security gate composing tool-declared permission results, modes/classification, path checks, and HITL permission management |
